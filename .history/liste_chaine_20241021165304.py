...
ma_liste = Liste()
ma_liste.ajout(Personne("franck","bansept", 25)) #0
ma_liste.ajout(Personne("tom","sawyer", 12)) #1


sous_liste = ma_liste.filter(lambda x : x.age >= 18).map(lambda x : x.prenom + "." + x.nom + "@gmail.com")
