...
articles = (
    ...
    ("https://placehold.co/600x400?text=natation", "Triathlon", " Triathlon (F) | Jeux Olympiques de Paris 2024 FRA v POL - Finale(H) | Volleyball | Jeux Olympiques de Paris 2024 Volleyball FRA v"), 
)
