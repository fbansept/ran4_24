...
ma_liste = Liste()
ma_liste.ajout(Personne("franck","bansept")) #0
ma_liste.ajout(Personne("tom","sawyer")) #1


sous_liste = ma_liste.appliquer_un_traitement_sur_chacun(lambda x : x.prenom + "." + x.nom + "@gmail.com")
