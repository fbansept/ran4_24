...
ma_liste = Liste()
ma_liste.ajout("franck.bansept") #0
ma_liste.ajout("franck.bansept") #1
ma_liste.ajout("franck.bansept") #2
ma_liste.ajout("franck.bansept") #3

sous_liste = ma_liste.appliquer_un_traitement_sur_chacun(lambda x : x + 1)
